...
# Loop through the table and assign the Faculty Name (or None) from the dictionary
...
for i, row in aux.iterrows():
    if row['Faculty_strcount'] > 1:
        ...
        for y, z in dict_lookup.items():
            if y in row['Faculty_situated']:
                Register_sensitive_research.loc[i, 'Faculty_name'] = z
                break
